...
#(4) useiniT2.py: here we use the initial temperature to represent the temperature profile but with sparse grid
if root['SETTINGS']['PHYSICS']['useiniT2'][0]==1:
    pvt_i=root['SETTINGS']['PHYSICS']['useiniT2'][1]
    drho_tgyro=root['SETTINGS']['PHYSICS']['drho_tgyro']
    num=int(pvt_i/drho_tgyro)+1
    diff_Ti=root['SETTINGS']['PHYSICS']['TIIN'][num]-root['SETTINGS']['PHYSICS']['TIIN_TGYRO'][num]
    diff_Te=root['SETTINGS']['PHYSICS']['TEIN'][num]-root['SETTINGS']['PHYSICS']['TEIN_TGYRO'][num]
    root['SETTINGS']['PHYSICS']['TIIN_TGYRO'][0:num]=root['SETTINGS']['PHYSICS']['TIIN'][0:num]-diff_Ti
