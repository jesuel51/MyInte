...
lw=3;  #linewidth
#rho=linspace(0,1,nj);
rho=root['INPUTS']['ONETWOInput']['inone']['NAMELIS1']['RTEIN']
...
if root['OUTPUTSRec']['ProfileGenOutput'].has_key(int(k)):
...
sbeam=root['INPUTSRec']['ProfileGen'][int(k)]['statefile']['sbeame']['data']
...
subplot(2,4,7)
#flow_wall=root['OUTPUTSRec']['ProfileGenOutput'][int(k)]['flow_wall']
f#low_beam=root['OUTPUTSRec']['ProfileGenOutput'][int(k)]['flow_beam']
